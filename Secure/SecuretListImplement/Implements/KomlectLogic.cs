...
namespace SecuretListImplement.Implements
{
    public class KomlectLogic : IKomlectLogic
    {
        ...
        public void CreateOrUpdate(KomlectKomlectBindingModel model)
        {
        ...
        public void Delete(KomlectKomlectBindingModel model)
        {
        ...
        private Komlect CreateModel(KomlectKomlectBindingModel model, Komlect Komlect)
        {
        ...
        public List<KomlectViewModel> Read(KomlectKomlectBindingModel model)
        {
